...
public class IntroLabTest {
     ...
     */
    @Test(timeout = 10)
    public void testClawsiek() {
        String expected = "Hello! My name is Kiera Clawsie! I like cats more than dogs! Does anyone have a glass of " +
                "water? I'm absolutely parched!";
        String actual = IntroLab.clawsiek();
        assertEquals(expected, actual);
    }
}
