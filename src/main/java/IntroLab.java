...
public class IntroLab {
     ...
     */
    /**
     * A method that calls on printLabMessage with kharicha's parameters.
     */
    public static String kharicha(){
        return printLabMessage("Hello","Richard", true , "Have a good one!");
    }
