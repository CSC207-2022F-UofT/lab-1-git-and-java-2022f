...
public class IntroLab {
    ...
    /***
     * A method that returns a introduction message from jasmine
     *
     */
    public static String zha11734() {
        return printLabMessage("hihi", "jasmine", true, "yay");
