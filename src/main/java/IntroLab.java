...
public class IntroLab {
    ...
    public static String printMsg(String utorId, boolean likeCats, String msg){
        return printLabMessage("Hello", utorId, likeCats, msg);
    }
    ...
    public static void main(final String[] args) {
        ...
        System.out.println(printMsg("xxx", false, "msg"));
