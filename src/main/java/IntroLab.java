...
public class IntroLab {
    ...
    /**
     * Returns something from printLabMessage. idk.
     *
     * @return My name and whether i like cats or not.
     */
    public static String chenoce1() {
        return printLabMessage("Hi", "Ocean Chen", true,
                "I like dogs too");
    }
