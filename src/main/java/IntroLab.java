...
public class IntroLab {
    ...
    /**
     * Returns a message build around Philip Harker, making use of
     * the printLabMessage() method.
     */
    public static String harkerph() {
        return printLabMessage("Salutations", "Philip Harker", true,
                "Climate Action Now!");
    }
